...
`r learnr("A04La_barres", title = "Graphique en barres", toc = "Graphiques en barres dans R")`
...
`r learnr("A04Lb_camembert", title = "Graphique en camembert", toc = "Graphiques en camembert dans R")`
...
`r learnr("A04Lc_boxplot", title = "Boite de dispersion", toc = "Boites de dispersion dans R")`
...
`r learnr("A04Ld_fig_composees", title = "Graphiques composés", toc = "Graphiques composés dans R")`
