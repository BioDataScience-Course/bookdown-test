...
- **De manière optionelle**, découvrir différents systèmes graphiques (graphiques de base, lattice, ggplot2) et les comparer entre eux
...
Proposez trois graphiques inédits (qui n'ont pas été vu jusqu'ici) dans vos différents projets. Employez par exemple les liens suivants pour vous inspirer :
