...
`r learnr("A02a_base", title = "Les bases de R", toc = "Tutoriel sur les bases de R")`
...
`r learnr("A02b_progression", title = "Progression R", toc = "Tutoriel de progression en R")`
...
`r learnr("A02c_nuage", title = "Nuage de points", toc = "Réalisation de graphiques en nuage de points dans R")`
...
Appliquez par vous même la modification des échelles des axes via l'application ci-dessous.

`r launch_shiny("https://sdd.umons.ac.be/A02a_limits/", height = 500, delay = 10, toc = "Choisir l'étendue des axes pour un graphique")`
...
`r launch_shiny("https://sdd.umons.ac.be/A02a_transformation/", height = 500, delay = 10, toc = "Choisir la transformation des axes d'un graphique")`
...
assignation("sdd1_urchin_bio", part = "I",
  url = "https://github.com/BioDataScience-Course/sdd1_urchin_bio",
  course.urls = c(
    'S-BIOG-006' = "https://classroom.github.com/a/GxS0euIC",
    'S-BIOG-921' = "https://classroom.github.com/a/p2m_RPt1"),
  toc = "Assignation : réaliser différents graphiques sur `urchin_bio`, partie I")
```
...
`r learnr("A02d_np_challenge", title = "Challenge nuage de points", toc = "Auto-évaluation des acquis concernant les nuages de points")`
...
Partez du projet **sdd1_urchin_bio** que vous avez obtenu via le lien GitHub Classroom dans la première partie de ce module. Votre objectif est de comprendre les données proposées, en utilisant des visualisations graphiques appropriées et en documentant le fruit de votre étude dans un rapport R Notebook. Utilisez le graphique en nuage de points que vous venez d'étudier, bien sûr, mais vous êtes aussi encouragés à expérimenter d'autres formes de visualisation graphique.

```{r, echo=FALSE, results='asis'}
assignation("sdd1_urchin_bio", part = "II",
  url = "https://github.com/BioDataScience-Course/sdd1_urchin_bio",
  course.urls = c(
    'S-BIOG-006' = "https://classroom.github.com/a/GxS0euIC",
    'S-BIOG-921' = "https://classroom.github.com/a/p2m_RPt1"),
  toc = "Assignation : réaliser différents graphiques sur `urchin_bio`, partie II")
```
...
```{r, echo=FALSE, results='asis'}
assignation("sdd1_biometry", part = "I",
  url = "https://github.com/BioDataScience-Course/sdd1_biometry",
  course.urls = c(
    'S-BIOG-006' = "https://classroom.github.com/g/Q1-L0PhW",
    'S-BIOG-921' = "https://classroom.github.com/g/jvDR9nhM"),
  toc = "Assignation : comparaison de workflows R-Word *versus* R-R Markdown")
```

## Récapitulatif des exercices

Ce module 2 vous a permis de réaliser vos premiers graphiques pour visualiser des données et vous a introduit à R Markdown, un système qui allie la facilité de Markdown pour l'écriture de documents textuels et la puissance de calcul de R pour y inclure des analyses directement. Pour évaluer votre compréhension de cette matière vous aviez les exercices suivants à réaliser\ :
