...
`r learnr("A02La_base", title = "Les bases de R", toc = "Tutoriel sur les bases de R")`
...
`r learnr("A02Lb_progression", title = "Progression R", toc = "Tutoriel de progression en R")`
...
`r learnr("A02Lc_nuage", title = "Nuage de points", toc = "Réalisation de graphiques en nuage de points dans R")`
...
`r launch_shiny("https://sdd.umons.ac.be/A02Sa_limits/", height = 500, delay = 10, toc = "Choisir l'étendue des axes pour un graphique")`
...
`r launch_shiny("https://sdd.umons.ac.be/A02Sa_transformation/", height = 500, delay = 10, toc = "Choisir la transformation des axes d'un graphique")`
...
assignation("A02Ga_nuagepoints", part = "I",
  ...
  toc = "Réalisez différents graphiques sur `urchin_bio` dans un script R, partie I")
```
...
assignation("A02Ga_nuagepoints", part = "II",
  ...
  course.urls = c(
    'S-BIOG-006' = "https://classroom.github.com/a/zRJk-Ie0",
    'S-BIOG-921' = "https://classroom.github.com/a/05EuaBKa"),
  toc = "Réalisez différents graphiques sur `urchin_bio` dans un R Markdown, partie II")
```
