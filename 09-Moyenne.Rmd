...
`r h5p(86, height = 400, toc = "Annotation mathématique")`
...
`r learnr("A09Lb_ttest_wmw", title = "Les tests t de Student et de Wilcoxon/Mann-Withney", toc = "Les tests t de Student et de Wilcoxon/Mann-Withney")`
