...
- des [exercices H5P](http://www.h5p.org) en ligne repérables par le logo [![h5p](images/list-h5p.png)](https://wp.sciviews.org/h5p/){target='_parent'} sur lequel vous pouvez cliquer pour avoir plus d'infos sur leur utilisation,
...
- des diapositives de présentations distribuées via le dépôt [sdd_lessons sur BioDataScience-Course](https://github.com/BioDataScience-Course/sdd_lessons/tree/2020-2021) viennent compléter le tout.
