...
`r h5p(17, height = 270, toc = "Premiers exercices relatifs à Markdown")`
...
Maintenant que vous avez appréhendé les différents outils, lancez vous dans la création de votre premier document rédigé en Markdown.
...
Afin de terminer ce module en beauté, il est temps d'auto-évaluer votre apprentissage via un **tutoriel** dans RStudio.

`r learnr("A01La_outils", title = "Les différents outils", toc = "Tutoriel : auto-évaluation sur les outils")`
